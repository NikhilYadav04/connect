        ...
        child: Column(
          ...
          children: [
            ...
            _buildSectionCard(
              ...
              children: [
                _buildTextField("Job Title", _jobTitleController, sw, sh,
                    hintText: "e.g., Senior Software Engineer", required: true),
                SizedBox(height: sh * 0.025),
                _buildTextField("Company", _companyController, sw, sh,
            ...
            _buildSectionCard(
              children: [
                ...
                SizedBox(height: sh * 0.025),
                _buildTextField(
                    "College/University", _collegeController, sw, sh,
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Average rate: \Rs.3-15/minute depending on expertise",
                      style: TextStyle(
                        fontSize: sh * 0.013,
                        fontFamily: "Jakarta-Light",
                        color: Colors.grey[600],
