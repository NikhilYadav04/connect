...
class Expert {
  ...
  // Factory constructor for creating Expert from JSON
  ...
  // Method to convert Expert to JSON
  ...
  @override
  String toString() {
    return 'Expert(id: $id, fullName: $fullName, email: $email, status: $status, isApproved: $isApproved)';
  }
